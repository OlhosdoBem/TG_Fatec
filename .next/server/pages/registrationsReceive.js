(function() {
var exports = {};
exports.id = "pages/registrationsReceive";
exports.ids = ["pages/registrationsReceive"];
exports.modules = {
...
/* harmony import */ var _styles_pages_RegistrationsReceive__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../styles/pages/RegistrationsReceive */ "./src/styles/pages/RegistrationsReceive.ts");
...
const RegistrationReceive = () => {
  ...
  return /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_styles_pages_Home__WEBPACK_IMPORTED_MODULE_2__.Container, {
      children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_styles_pages_RegistrationsReceive__WEBPACK_IMPORTED_MODULE_4__.ViewLoginFrame, {
        children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_styles_pages_RegistrationsReceive__WEBPACK_IMPORTED_MODULE_4__.LoginFrame, {
          children: [/*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_styles_pages_RegistrationsReceive__WEBPACK_IMPORTED_MODULE_4__.Close, {
            ...
            lineNumber: 41,
            columnNumber: 13
          }, undefined), /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_styles_pages_RegistrationsReceive__WEBPACK_IMPORTED_MODULE_4__.Title, {
            children: "Cadastre-se"
          }, void 0, false, {
            fileName: _jsxFileName,
            lineNumber: 46,
            columnNumber: 13
          }, undefined), /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_styles_pages_RegistrationsReceive__WEBPACK_IMPORTED_MODULE_4__.ForgotLink, {
            children: " \xC9 r\xE1pido e f\xE1cil"
          }, void 0, false, {
            fileName: _jsxFileName,
            lineNumber: 49,
            columnNumber: 13
          }, undefined), /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_styles_pages_RegistrationsReceive__WEBPACK_IMPORTED_MODULE_4__.Fields2, {
            children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_styles_pages_RegistrationsReceive__WEBPACK_IMPORTED_MODULE_4__.Name, {
            ...
            lineNumber: 80,
            columnNumber: 13
          }, undefined), /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_styles_pages_RegistrationsReceive__WEBPACK_IMPORTED_MODULE_4__.Fields3, {
            children: /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_styles_pages_RegistrationsReceive__WEBPACK_IMPORTED_MODULE_4__.Name, {
            ...
            lineNumber: 81,
            columnNumber: 13
          }, undefined), /*#__PURE__*/(0,react_jsx_dev_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxDEV)(_styles_pages_RegistrationsReceive__WEBPACK_IMPORTED_MODULE_4__.SigninButton, {
            children: "Cadastre-se"
          }, void 0, false, {
            fileName: _jsxFileName,
            lineNumber: 87,
...
const Container = styled_components__WEBPACK_IMPORTED_MODULE_0___default().div.withConfig({
  ...
  componentId: "sc-18p7wbw-0"
})([""]);

/***/ }),

/***/ "./src/styles/pages/RegistrationsReceive.ts":
/*!**************************************************!*\
  !*** ./src/styles/pages/RegistrationsReceive.ts ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "Fields3": function() { return /* binding */ Fields3; },
...
const ViewLoginFrame = styled_components__WEBPACK_IMPORTED_MODULE_0___default().div.withConfig({
  displayName: "RegistrationsReceive__ViewLoginFrame",
  componentId: "sc-ff8j83-0"
...
const LoginFrame = styled_components__WEBPACK_IMPORTED_MODULE_0___default().div.withConfig({
  displayName: "RegistrationsReceive__LoginFrame",
  componentId: "sc-ff8j83-1"
})(["width:625px;height:650px;padding:40px 35px 35px 35px;border-radius:40px;background:", ";box-shadow:13px 13px 20px ", ",-13px -13px 20px ", ";"], props => props.theme.primary.main, props => props.theme.primary.dark, props => props.theme.primary.light);
const Logo = styled_components__WEBPACK_IMPORTED_MODULE_0___default().div.withConfig({
  displayName: "RegistrationsReceive__Logo",
  componentId: "sc-ff8j83-2"
...
const Title = styled_components__WEBPACK_IMPORTED_MODULE_0___default().div.withConfig({
  displayName: "RegistrationsReceive__Title",
  componentId: "sc-ff8j83-3"
...
const SubTitle = styled_components__WEBPACK_IMPORTED_MODULE_0___default().div.withConfig({
  displayName: "RegistrationsReceive__SubTitle",
  componentId: "sc-ff8j83-4"
})(["text-align:right;font-size:15px;padding-top:7px;letter-spacing:3px;"]);
const Fields = styled_components__WEBPACK_IMPORTED_MODULE_0___default().div.withConfig({
  displayName: "RegistrationsReceive__Fields",
  componentId: "sc-ff8j83-5"
})(["width:100%;padding:55px 5px 5px 5px;& input{border:none;outline:none;background:none;font-size:16px;color:#555;padding:28px 10px 20px 5px;}& svg{height:22px;margin:0 10px -3px 25px;}& textarea{border:none;outline:none;background:none;font-size:16px;color:#555;padding:28px 10px 20px 5px;}"]);
const Fields2 = styled_components__WEBPACK_IMPORTED_MODULE_0___default().div.withConfig({
  displayName: "RegistrationsReceive__Fields2",
  componentId: "sc-ff8j83-6"
})(["width:100%;padding:0px 5px 0px 5px;& input{margin:0px 19px 0px 0px;width:523px;border:none;outline:none;background:none;font-size:14px;color:#555;padding:10px 10px 10px 30px;}& svg{height:22px;margin:0 10px -3px 25px;}"]);
const Fields3 = styled_components__WEBPACK_IMPORTED_MODULE_0___default().div.withConfig({
  displayName: "RegistrationsReceive__Fields3",
  componentId: "sc-ff8j83-7"
})(["width:100%;padding:0px 5px 0px 5px;& input{border:none;outline:none;background:none;font-size:16px;color:#555;padding:20px 10px 25px 30px;margin-bottom:40px;resize:horizontal;}& svg{height:22px;margin:0 10px -3px 25px;}& textarea{margin:0px 19px 0px 0px;width:523px;height:105px;border:none;outline:none;background:none;font-size:16px;color:#555;padding:28px 10px 20px 30px;resize:none;}"]);
const Username = styled_components__WEBPACK_IMPORTED_MODULE_0___default().div.withConfig({
  displayName: "RegistrationsReceive__Username",
  componentId: "sc-ff8j83-8"
...
const Name = styled_components__WEBPACK_IMPORTED_MODULE_0___default().div.withConfig({
  displayName: "RegistrationsReceive__Name",
  componentId: "sc-ff8j83-9"
})(["margin-bottom:30px;border-radius:35px;box-shadow:inset 8px 8px 8px ", ",inset -8px -8px 8px ", ";"], props => props.theme.primary.dark, props => props.theme.primary.light);
const Password = styled_components__WEBPACK_IMPORTED_MODULE_0___default().div.withConfig({
  displayName: "RegistrationsReceive__Password",
  componentId: "sc-ff8j83-10"
})(["margin-bottom:30px;border-radius:35px;box-shadow:inset 8px 8px 8px ", ",inset -8px -8px 8px ", ";"], props => props.theme.primary.dark, props => props.theme.primary.light);
const SigninButton = styled_components__WEBPACK_IMPORTED_MODULE_0___default().button.withConfig({
  displayName: "RegistrationsReceive__SigninButton",
  componentId: "sc-ff8j83-11"
...
const ForgotLink = styled_components__WEBPACK_IMPORTED_MODULE_0___default().div.withConfig({
  displayName: "RegistrationsReceive__ForgotLink",
  componentId: "sc-ff8j83-12"
})(["margin:10px;padding-bottom:20px;text-align:start;font-size:15px;& a{text-decoration:none;color:#000;}"]);
const Close = styled_components__WEBPACK_IMPORTED_MODULE_0___default().div.withConfig({
  displayName: "RegistrationsReceive__Close",
  componentId: "sc-ff8j83-13"
